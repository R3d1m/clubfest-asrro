  ...
  return (
    <div className="w-full flex-1 flex flex-col justify-between py-2 px-1 sm:px-3 animate-bounce-in">
      <div className="pop-box w-full p-4 sm:p-6 bg-[#FFFBEB] flex flex-col justify-between space-y-4 shadow-pop-lg">
        ...
        <div className="flex items-center space-x-3.5 border-b-2 border-dashed border-[#1E232A]/20 pb-3">
          <div 
            className="w-16 h-16 rounded-2xl border-3 border-[#1E232A] shadow-pop-sm flex flex-col items-center justify-center animate-bounce flex-shrink-0"
          ...
          <div className="text-left">
            <div className="inline-flex items-center space-x-1 px-2.5 py-0.5 bg-[#D4F8F0] border border-[#1E232A] rounded-full text-[10px] sm:text-xs font-black text-[#00897B] mb-0.5">
            ...
            <p className="text-xs font-bold text-gray-500 font-bangla">
        ...
        <div className="space-y-2.5 text-left font-bangla">
          <div className="p-3 bg-white rounded-2xl border-2 border-[#1E232A] shadow-pop-sm flex items-start space-x-3">
            <span className="text-2xl flex-shrink-0">🛡️</span>
            <div className="text-xs sm:text-sm leading-snug">
              <strong className="text-[#1E232A] font-black block text-sm sm:text-base mb-0.5">
        ...
        {/* Warning Banner */}
        <div className="p-3 bg-[#FFE0E2] rounded-xl border-2 border-[#FF5964] text-left flex items-center space-x-2.5">
          <AlertTriangle className="w-5 h-5 text-[#D32F2F] flex-shrink-0 animate-pulse" />
          <p className="text-xs sm:text-sm font-black font-bangla text-[#D32F2F] leading-tight">
